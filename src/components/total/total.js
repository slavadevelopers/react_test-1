    ...
    render() {
        return (
            <div>
                ...
                <p className="total">{ this.props.timeItem.costAll } руб. {this.props.total.total ? <span> + 150 руб. =
                ...
                <div>
                    <button className="btn btn-primary" onClick={ this.goalTest.bind(this) }>Купить</button>
                </div>
            </div>
        );
    }
